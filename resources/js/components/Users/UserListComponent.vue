               ...
               <table class="table table-bordered text-nowrap dataTable no-footer" id="example1"
                                    ...
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="wd-15p border-bottom-0 sorting sorting_asc" tabindex="0">Designation</th>



                                            <th class="wd-15p border-bottom-0 sorting sorting_asc" tabindex="0">Phone</th>

                                            <th class="wd-15p border-bottom-0 sorting sorting_asc" tabindex="0">Status</th>

                                            <th class="wd-15p border-bottom-0 sorting sorting_asc" tabindex="0">Assign To</th>
