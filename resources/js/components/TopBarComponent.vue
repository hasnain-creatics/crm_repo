  				...
  				<div class="container-fluid">
								<div class="d-flex">
									<a class="header-brand" href="index.html">
										<img :src="vue_path+'/assets/images/brand/logo.png'" class="header-brand-img desktop-lgo" alt="Azea logo">
										<img :src="vue_path+'/assets/images/brand/logo1.png'" class="header-brand-img dark-logo" alt="Azea logo">
										<img :src="vue_path+'/assets/images/brand/favicon.png'" class="header-brand-img mobile-logo" alt="Azea logo">
										<img :src="vue_path+'/assets/images/brand/favicon1.png'" class="header-brand-img darkmobile-logo" alt="Azea logo">
									</a>
