	...
	/*RTL Layout Style End*/
		...
		$(document).ready (function(){
			...
			if (bodyRtl) {
					...
					(document.getElementById("style")?.setAttribute("href", public_url+"/assets/plugins/bootstrap/css/bootstrap.rtl.min.css"));
				} 
				else {
					$('body').removeClass('rtl');
					localStorage.setItem("rtl", "false");
					$("head link#style").attr("href", $(this));
					(document.getElementById("style")?.setAttribute("href", public_url+"/assets/plugins/bootstrap/css/bootstrap.min.css"));
				};
		});
